...
def get_inline_keyboard(data):
    keyboard = InlineKeyboardMarkup(row_width=1)
    buttons = [
        InlineKeyboardButton(text="Tanishish", url=data[0]), #"Hududni o'zgartirish","data":"change_region"
        InlineKeyboardButton(text="Ovoz berish", callback_data=f"voice_{data[2]}"),
        InlineKeyboardButton(text="Universitet/Institut o'zgartirish", callback_data=f"change_condidate")
    ]
    keyboard.add(*buttons)
    return keyboard
